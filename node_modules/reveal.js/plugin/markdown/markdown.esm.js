...
const n = /[&<>"']/, s = new RegExp(n.source, "g"), r = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
    i = new RegExp(r.source, "g"), l = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"},
    o = e => l[e];
...
function u(e, t) {
    ...
    const n = {
        replace: (t, s) => (s = (s = s.source || s).replace(p, "$1"), e = e.replace(t, s), n),
...
function z(e, t, n, s) {
    const r = t.href, i = t.title ? a(t.title) : null, l = e[1].replace(/\\([\[\]])/g, "$1");
    if ("!" !== e[0].charAt(0)) {
        s.state.inLink = !0;
...
class S {
    ...
    blockquote(e) {
        ...
        if (t) {
            const e = t[0].replace(/^ *>[ \t]?/gm, ""), n = this.lexer.state.top;
    ...
    list(e) {
        ...
        if (t) {
            ...
            const f = d.length > 1,
                k = {type: "list", raw: "", ordered: f, start: f ? +d.slice(0, -1) : "", loose: !1, items: []};
            ...
            for (; e && (g = !1, t = x.exec(e)) && !this.rules.block.hr.test(e);) {
                if (n = t[0], e = e.substring(n.length), c = t[2].split("\n", 1)[0].replace(/^\t+/, (e => " ".repeat(3 * e.length))), h = e.split("\n", 1)[0], this.options.pedantic ? (i = 2, u = c.trimLeft()) : (i = t[2].search(/[^ ]/), i = i > 4 ? 1 : i, u = c.slice(i), i += t[1].length), o = !1, !c && /^ *$/.test(h) && (n += h + "\n", e = e.substring(h.length + 1), g = !0), !g) {
                    ...
                    for (; e && (p = e.split("\n", 1)[0], h = p, this.options.pedantic && (h = h.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")), !r.test(h)) && !l.test(h) && !t.test(h) && !s.test(e);) {
                        ...
                        o || h.trim() || (o = !0), n += p + "\n", e = e.substring(p.length + 1), c = h.slice(i)
                    }
                }
                k.loose || (a ? k.loose = !0 : /\n *\n *$/.test(n) && (a = !0)), this.options.gfm && (s = /^\[[ xX]\] /.exec(u), s && (r = "[ ] " !== s[0], u = u.replace(/^\[[ xX]\] +/, ""))), k.items.push({
                    type: "list_item",
                    raw: n,
                    task: !!s,
                    checked: r,
            ...
            for (l = 0; l < m; l++) if (this.lexer.state.top = !1, k.items[l].tokens = this.lexer.blockTokens(k.items[l].text, []), !k.loose) {
    ...
    html(e) {
        ...
        if (t) {
            ...
            if (this.options.sanitize) {
                const n = this.options.sanitizer ? this.options.sanitizer(t[0]) : a(t[0]);
    ...
    table(e) {
        ...
        if (t) {
            ...
            if (e.header.length === e.align.length) {
                ...
                for (l = e.rows.length, n = 0; n < l; n++) e.rows[n] = _(e.rows[n], e.header.length).map((e => ({text: e})));
                for (l = e.header.length, s = 0; s < l; s++) e.header[s].tokens = this.lexer.inline(e.header[s].text);
                for (l = e.rows.length, s = 0; s < l; s++) for (i = e.rows[s], r = 0; r < i.length; r++) i[r].tokens = this.lexer.inline(i[r].text);
                return e
            }
        }
    }
    ...
    tag(e) {
        ...
        if (t) return !this.lexer.state.inLink && /^<a /i.test(t[0]) ? this.lexer.state.inLink = !0 : this.lexer.state.inLink && /^<\/a>/i.test(t[0]) && (this.lexer.state.inLink = !1), !this.lexer.state.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(t[0]) ? this.lexer.state.inRawBlock = !0 : this.lexer.state.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0]) && (this.lexer.state.inRawBlock = !1), {
            ...
            text: this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(t[0]) : a(t[0]) : t[0]
        }
    }
        ...
        if (t) {
            ...
            if (!this.options.pedantic && /^</.test(e)) {
                ...
                const e = function (e, t) {
                    ...
                    const n = e.length;
                    let s = 0, r = 0;
                    for (; r < n; r++) if ("\\" === e[r]) r++; else if (e[r] === t[0]) s++; else if (e[r] === t[1] && (s--, s < 0)) return r;
                    return -1
                }(t[2], "()");
                if (e > -1) {
            ...
            return n = n.trim(), /^</.test(n) && (n = this.options.pedantic && !/>$/.test(e) ? n.slice(1) : n.slice(1, -1)), z(t, {
    ...
    codespan(e) {
        ...
        if (t) {
            ...
            return n && s && (e = e.substring(1, e.length - 1)), e = a(e, !0), {type: "codespan", raw: t[0], text: e}
        }
    }
    ...
    autolink(e, t) {
        ...
        if (n) {
            let e, s;
            return "@" === n[2] ? (e = a(this.options.mangle ? t(n[1]) : n[1]), s = "mailto:" + e) : (e = a(n[1]), s = e), {
                type: "link",
                raw: n[0],
                text: e,
                href: s,
    ...
    url(e, t) {
        ...
        if (n = this.rules.inline.url.exec(e)) {
            let e, s;
            if ("@" === n[2]) e = a(this.options.mangle ? t(n[0]) : n[0]), s = "mailto:" + e; else {
                let t;
                do {
            ...
            return {type: "link", raw: n[0], text: e, href: s, tokens: [{type: "text", raw: e, text: e}]}
        }
    }
    ...
    inlineText(e, t) {
        ...
        if (n) {
            let e;
            return e = this.lexer.state.inRawBlock ? this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(n[0]) : a(n[0]) : n[0] : a(this.options.smartypants ? t(n[0]) : n[0]), {
                type: "text",
                raw: n[0],
                text: e
            }
...
T._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~", T.punctuation = u(T.punctuation).replace(/punctuation/g, T._punctuation).getRegex(), T.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g, T.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g, T._comment = u(R._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(), T.emStrong.lDelim = u(T.emStrong.lDelim).replace(/punct/g, T._punctuation).getRegex(), T.emStrong.rDelimAst = u(T.emStrong.rDelimAst, "g").replace(/punct/g, T._punctuation).getRegex(), T.emStrong.rDelimUnd = u(T.emStrong.rDelimUnd, "g").replace(/punct/g, T._punctuation).getRegex(), T._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, T._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, T._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, T.autolink = u(T.autolink).replace("scheme", T._scheme).replace("email", T._email).getRegex(), T._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, T.tag = u(T.tag).replace("comment", T._comment).replace("attribute", T._attribute).getRegex(), T._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, T._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/, T._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, T.link = u(T.link).replace("label", T._label).replace("href", T._href).replace("title", T._title).getRegex(), T.reflink = u(T.reflink).replace("label", T._label).replace("ref", R._label).getRegex(), T.nolink = u(T.nolink).replace("ref", R._label).getRegex(), T.reflinkSearch = u(T.reflinkSearch, "g").replace("reflink", T.reflink).replace("nolink", T.nolink).getRegex(), T.normal = {...T}, T.pedantic = {
    ...
    link: u(/^!?\[(label)\]\((.*?)\)/).replace("label", T._label).getRegex(),
    reflink: u(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", T._label).getRegex()
}, T.gfm = {
    ...T.normal,
...
}, T.gfm.url = u(T.gfm.url, "i").replace("email", T.gfm._extended_email).getRegex(), T.breaks = {
    ...T.gfm,
    br: u(T.br).replace("{2,}", "*").getRegex(),
    text: u(T.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
};

class v {
    constructor(e) {
        this.tokens = [], this.tokens.links = Object.create(null), this.options = e || t, this.options.tokenizer = this.options.tokenizer || new S, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
            inLink: !1,
            inRawBlock: !1,
            top: !0
        };
        const n = {block: R.normal, inline: T.normal};
        this.options.pedantic ? (n.block = R.pedantic, n.inline = T.pedantic) : this.options.gfm && (n.block = R.gfm, this.options.breaks ? n.inline = T.breaks : n.inline = T.gfm), this.tokenizer.rules = n
    }
    ...
    inlineTokens(e, t = []) {
        ...
        if (this.tokens.links) {
            ...
            if (e.length > 0) for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(a));) e.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (a = a.slice(0, i.index) + "[" + $("a", i[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
        }
        for (; null != (i = this.tokenizer.rules.inline.blockSkip.exec(a));) a = a.slice(0, i.index) + "[" + $("a", i[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
        ...
        for (; e;) if (l || (o = ""), l = !1, !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some((s => !!(n = s.call({lexer: this}, e, t)) && (e = e.substring(n.raw.length), t.push(n), !0))))) if (n = this.tokenizer.escape(e)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.tag(e)) e = e.substring(n.raw.length), s = t[t.length - 1], s && "text" === n.type && "text" === s.type ? (s.raw += n.raw, s.text += n.text) : t.push(n); else if (n = this.tokenizer.link(e)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(n.raw.length), s = t[t.length - 1], s && "text" === n.type && "text" === s.type ? (s.raw += n.raw, s.text += n.text) : t.push(n); else if (n = this.tokenizer.emStrong(e, a, o)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.codespan(e)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.br(e)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.del(e)) e = e.substring(n.raw.length), t.push(n); else if (n = this.tokenizer.autolink(e, E)) e = e.substring(n.raw.length), t.push(n); else if (this.state.inLink || !(n = this.tokenizer.url(e, E))) {
            ...
            if (n = this.tokenizer.inlineText(r, A)) e = e.substring(n.raw.length), "_" !== n.raw.slice(-1) && (o = n.raw.slice(-1)), l = !0, s = t[t.length - 1], s && "text" === s.type ? (s.raw += n.raw, s.text += n.text) : t.push(n); else if (e) {
                const t = "Infinite loop on byte: " + e.charCodeAt(0);
                if (this.options.silent) {
                    console.error(t);
                    break
...
class C {
    constructor(e) {
        this.options = e || t, this.options.renderer = this.options.renderer || new I, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new q, this.slugger = new L
    }
    ...
    parse(e, t = !0) {
        let n, s, r, i, l, o, a, c, p, u, g, d, f, k, x, m, b, w, _, y = "";
        const $ = e.length;
        for (n = 0; n < $; n++) if (u = e[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[u.type] && (_ = this.options.extensions.renderers[u.type].call({parser: this}, u), !1 !== _ || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(u.type))) y += _ || ""; else switch (u.type) {
            case"space":
                continue;
            case"hr":
                y += this.renderer.hr();
            ...
            case"code":
                ...
                continue;
            case"table":
                for (c = "", a = "", i = u.header.length, s = 0; s < i; s++) a += this.renderer.tablecell(this.parseInline(u.header[s].tokens), {
                    header: !0,
                    align: u.align[s]
                });
                for (c += this.renderer.tablerow(a), p = "", i = u.rows.length, s = 0; s < i; s++) {
                    for (o = u.rows[s], a = "", l = o.length, r = 0; r < l; r++) a += this.renderer.tablecell(this.parseInline(o[r].tokens), {
                        header: !1,
                        align: u.align[r]
                    });
            ...
            case"paragraph":
                ...
                continue;
            case"text":
                for (p = u.tokens ? this.parseInline(u.tokens) : u.text; n + 1 < $ && "text" === e[n + 1].type;) u = e[++n], p += "\n" + (u.tokens ? this.parseInline(u.tokens) : u.text);
    ...
    parseInline(e, t) {
        ...
        let n, s, r, i = "";
        const l = e.length;
        for (n = 0; n < l; n++) if (s = e[n], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[s.type] && (r = this.options.extensions.renderers[s.type].call({parser: this}, s), !1 !== r || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(s.type))) i += r || ""; else switch (s.type) {
            case"escape":
            case"text":
                i += t.text(s.text);
                break;
    ...
    return (n, s, r) => {
        ...
        if (function (e) {
            ...
            const a = function (e) {
                let n;
                if (!e) try {
                    s.walkTokens && M.walkTokens(o, s.walkTokens), n = t(o, s), s.hooks && (n = s.hooks.postprocess(n))
                } catch (t) {
                    e = t
                }
            ...
            let c = 0;
            return M.walkTokens(o, (function (e) {
        ...
        if (s.async) return Promise.resolve(s.hooks ? s.hooks.preprocess(n) : n).then((t => e(t, s))).then((e => s.walkTokens ? Promise.all(M.walkTokens(e, s.walkTokens)).then((() => e)) : e)).then((e => t(e, s))).then((e => s.hooks ? s.hooks.postprocess(e) : e)).catch(l);
        try {
...
M.options = M.setOptions = function (e) {
...
}, M.getDefaults = e, M.defaults = t, M.use = function (...e) {
    const t = M.defaults.extensions || {renderers: {}, childTokens: {}};
    e.forEach((e => {
        const n = {...e};
        if (n.async = M.defaults.async || n.async || !1, e.extensions && (e.extensions.forEach((e => {
        ...
        if (e.hooks) {
            ...
            for (const n in e.hooks) {
                const s = t[n];
                Z.passThroughHooks.has(n) ? t[n] = r => {
                    if (M.defaults.async) return Promise.resolve(e.hooks[n].call(t, r)).then((e => s.call(t, e)));
        ...
        if (e.walkTokens) {
            ...
            n.walkTokens = function (n) {
                let s = [];
                return s.push(e.walkTokens.call(this, n)), t && (s = s.concat(t.call(this, n))), s
            }
        }
        M.setOptions(n)
    }))
    ...
    let n = [];
    for (const s of e) switch (n = n.concat(t.call(M, s)), s.type) {
        case"table":
            for (const e of s.header) n = n.concat(M.walkTokens(e.tokens, t));
            for (const e of s.rows) for (const s of e) n = n.concat(M.walkTokens(s.tokens, t));
            break;
        case"list":
            n = n.concat(M.walkTokens(s.items, t));
            break;
        default:
            M.defaults.extensions && M.defaults.extensions.childTokens && M.defaults.extensions.childTokens[s.type] ? M.defaults.extensions.childTokens[s.type].forEach((function (e) {
 ...
 */
const N = "__SCRIPT_END__", O = /\[\s*((\d*):)?\s*([\s\d,|-]*)\]/,
    D = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"}, B = () => {
        let e;
        ...
        function t(e) {
            ...
            return s > 0 ? t = t.replace(new RegExp("\\n?\\t{" + s + "}(.*)", "g"), (function (e, t) {
                return "\n" + t
        ...
        function n(e) {
            ...
            for (let e = 0, s = t.length; e < s; e++) {
                const s = t[e].name, r = t[e].value;
                /data\-(markdown|separator|vertical|notes)/gi.test(s) || (r ? n.push(s + '="' + r + '"') : n.push(s))
            }
            return n.join(" ")
        }
        ...
        function s(t) {
            ...
            return (t = t || {}).separator = t.separator || n?.separator || "\r?\n---\r?\n", t.verticalSeparator = t.verticalSeparator || n?.verticalSeparator || null, t.notesSeparator = t.notesSeparator || n?.notesSeparator || "^s*notes?:", t.attributes = t.attributes || "", t
        }

        function r(e, t) {
            t = s(t);
            const n = e.split(new RegExp(t.notesSeparator, "mgi"));
            return 2 === n.length && (e = n[0] + '<aside class="notes">' + M(n[1].trim()) + "</aside>"), '<script type="text/template">' + (e = e.replace(/<\/script>/g, N)) + "<\/script>"
        }
        ...
        function i(e, t) {
            ...
            let l, o, a, c = 0, h = !0, p = [];
            for (; l = n.exec(e);) o = i.test(l[0]), !o && h && p.push([]), a = e.substring(c, l.index), o && h ? p.push(a) : p[p.length - 1].push(a), c = n.lastIndex, h = o;
            ...
            })), u += "</section>") : u += "<section " + t.attributes + " data-markdown>" + r(p[e], t) + "</section>";
            return u
        }
        ...
        function l(e) {
            return new Promise((function (s) {
                const r = [];
                [].slice.call(e.querySelectorAll("section[data-markdown]:not([data-markdown-parsed])")).forEach((function (e, s) {
                    e.getAttribute("data-markdown").length ? r.push(function (e) {
                        return new Promise((function (t, n) {
                            const s = new XMLHttpRequest, r = e.getAttribute("data-markdown"),
                                i = e.getAttribute("data-charset");
                            null !== i && "" !== i && s.overrideMimeType("text/html; charset=" + i), s.onreadystatechange = function (e, s) {
                                4 === s.readyState && (s.status >= 200 && s.status < 300 || 0 === s.status ? t(s, r) : n(s, r))
                            }.bind(this, e, s), s.open("GET", r, !0);
                            try {
                                s.send()
                            } catch (e) {
                                console.warn("Failed to get the Markdown file " + r + ". Make sure that the presentation and the file are served by a HTTP server and the file can be found there. " + e), t(s, r)
                            }
                        }))
                    }(e).then((function (t, s) {
        ...
        function o(e, t, n) {
            const s = new RegExp(n, "mg"), r = new RegExp('([^"= ]+?)="([^"]+?)"|(data-[^"= ]+?)(?=[" ])', "mg");
            let i, l, o = e.nodeValue;
            if (i = s.exec(o)) {
                const n = i[1];
                for (o = o.substring(0, i.index) + o.substring(s.lastIndex), e.nodeValue = o; l = r.exec(n);) l[2] ? t.setAttribute(l[1], l[2]) : t.setAttribute(l[3], "");
                return !0
            }
            return !1
        }
        ...
        function a(e, t, n, s, r) {
            if (null !== t && void 0 !== t.childNodes && t.childNodes.length > 0) {
                ...
                for (let i = 0; i < t.childNodes.length; i++) {
                    ...
                    let o = e;
                    "section" === l.nodeName && (o = l, n = l), "function" != typeof l.setAttribute && l.nodeType !== Node.COMMENT_NODE || a(o, l, n, s, r)
                }
            }
        ...
        function c() {
            ...
            return [].slice.call(n).forEach((function (e) {
                ...
                const n = e.querySelector("aside.notes"), s = t(e);
                e.innerHTML = M(s), a(e, e, null, e.getAttribute("data-element-attributes") || e.parentNode.getAttribute("data-element-attributes") || "\\.element\\s*?(.+?)$", e.getAttribute("data-attributes") || e.parentNode.getAttribute("data-attributes") || "\\.slide:\\s*?(\\S.+?)$"), n && e.appendChild(n)
            })), Promise.resolve()
        }

        return {
            id: "markdown", init: function (t) {
                e = t;
                let {renderer: n, animateLists: s, ...r} = e.getConfig().markdown || {};
                return n || (n = new M.Renderer, n.code = (e, t) => {
                    let n = "", s = "";
                    if (O.test(t)) {
                        let e = t.match(O)[2];
                        e && (n = `data-ln-start-from="${e.trim()}"`), s = t.match(O)[3].trim(), s = `data-line-numbers="${s}"`, t = t.replace(O, "").trim()
                    }
                    return `<pre><code ${s} ${n} class="${t}">${e = e.replace(/([&<>'"])/g, (e => D[e]))}</code></pre>`
                }), !0 === s && (n.listitem = e => `<li class="fragment">${e}</li>`), M.setOptions({renderer: n, ...r}), l(e.getRevealElement()).then(c)
            }, processSlides: l, convertSlides: c, slidify: i, marked: M
        }
    };
export {B as default};
